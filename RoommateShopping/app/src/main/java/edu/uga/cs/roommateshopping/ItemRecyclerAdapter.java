...
/**
 * A {@link RecyclerView} subclass that represents the recycler view for the items.
 */
public class ItemRecyclerAdapter extends RecyclerView.Adapter<ItemRecyclerAdapter.ItemHolder> {
    ...
    class ItemHolder extends RecyclerView.ViewHolder {
         ...
         * of an item.
         * @param itemView Represents the view of each item.
         */
    ...
    /**
     * Fills the values of the views to display the item.
    ...
    public void onBindViewHolder(ItemHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                EditItemDialogFragment editFragment = EditItemDialogFragment.newInstance
